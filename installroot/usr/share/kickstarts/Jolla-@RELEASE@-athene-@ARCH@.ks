# DisplayName: Jolla athene/@ARCH@ (release) 1
...
repo --name=adaptation-community-common-athene-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
@Jolla Configuration athene
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/athene
